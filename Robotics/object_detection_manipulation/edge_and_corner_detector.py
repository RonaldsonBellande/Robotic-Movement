...
for image in images:
    ...
    laplacian_plus_picture = laplacian + gray_scale
    laplacian_plus_picture = cv2.Laplacian(image_noise_removal, cv2.CV_64F)
    save_edge_image(laplacian, file_name, edge_detector = "laplacian_plus_picture")
    ...
    save_edge_image(sobel_x_axis, file_name, edge_detector = "sobel_x_axis_plus_picture")
    ...
    save_edge_image(sobel_y_axis, file_name, edge_detector = "sobel_y_axis_plus_picture")
    
    merge_xy_axis_plus_picture = merge_xy_axis + gray_scale
    merge_xy_axis_plus_picture = sobel_x_axis + sobel_y_axis
    save_edge_image(sobel_y_axis, file_name, edge_detector = "merge_xy_axis_plus_picture")
    
    canny_plus_picture = canny + gray_scale
    canny_plus_picture = cv2.Canny(image_noise_removal, 100,200)
    save_edge_image(canny, file_name, edge_detector = "canny_plus_picture")
